                ...
                <div data-aos="fade-up">
                    <div class="d-md-flex justify-content-between">
                        <div class="grid-margin d-flex justify-content-start">
                            <div class="features-width">
                                ...
                                <p class="text-muted">Lomba Startup Inovation ini diadakan oleh PERMIKOMNAS Wilayah IV
                                    Banten yang diadakan secara online pada Tanggal 10-11 April 2021.</p>
                                <a href="#">
                        ...
                        <div class="grid-margin d-flex justify-content-center">
                            <div class="features-width">
                                <img src="assets/images/clapperboard.png" height="65" width="65" alt=""
                                    class="img-icons">
                        ...
                        <div class="grid-margin d-flex justify-content-end">
                            <div class="features-width">
                                <img src="assets/images/computer.png" height="65" width="65" alt=""
                                    class="img-icons">
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-lg-7 grid-margin grid-margin-lg-0" data-aos="fade-right">
                        ...
                        <div class="col-lg-7 col-xl-6 p-0">
                            ...
                            <p class="font-weight-medium text-muted"> Lomba Mobile Legend, Lomba Desain Grafis, Lomba Web
                                Design.</p>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-lg-5 flex-item grid-margin" data-aos="fade-left">
                        ...
                        <div class="col-lg-9 col-xl-8 p-0">
                            ...
                            <p class="pb-2 font-weight-medium text-muted">Colaboration team in the startup industry with
                                laravel x
                                sourcetree.</p>
                        </div>
                ...
                <div class="row">
                    <div class="owl-carousel owl-theme grid-margin">
                        <div class="card customer-cards">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="assets/images/rajif.jpeg" width="89" height="89" alt=""
                                        class="img-customer">
                        ...
                        <div class="card customer-cards">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="assets/images/viky.jpeg" width="89" height="89" alt=""
                                        class="img-customer">
                        ...
                        <div class="card customer-cards">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="assets/images/asad.jpeg" width="89" height="89" alt=""
                                        class="img-customer">
                                    <p class="m-0 py-3 text-muted">Mobile Application Developer di PT. Cudo Communications.
                                    </p>
                                    <div class="content-divider m-auto"></div>
                        ...
                        <div class="card customer-cards">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="assets/images/rangga.jpeg" width="89" height="89" alt=""
                                        class="img-customer">
                                    <p class="m-0 py-3 text-muted">Android Developer di PT. STARCOM TECHNOLOGY INDONESIA.
                                    </p>
                                    <div class="content-divider m-auto"></div>
                ...
                <div class="row">
                    <div class="owl-carousel owl-theme grid-margin">
                        <div class="card customer-cards">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="assets/images/permikomnas.png" width="89" height="89"
